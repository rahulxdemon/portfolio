...
export function BaseWork() {
  return (
    <div className='space-y-7.5 py-8'>
      ...
      <div className='text-neutral-600 font-medium group/wrapper'>
        {WORK_EXPERIENCE.map((work, i) => (
          <div
            key={i}
            className='group/parent hover:px-2 hover:opacity-100 hover:text-text transition-[padding,opacity] py-1.25 group-hover/wrapper:opacity-60 flex items-center justify-between gap-4 duration-300'
          >
